...
# DATA WRANGLING
## Gathering Data
df_orders = pd.read_csv("brazilian-ecommerce-analysis/dashboard/olist_orders_dataset.csv")
df_reviews = pd.read_csv("brazilian-ecommerce-analysis/dashboard/olist_order_reviews_dataset.csv")
